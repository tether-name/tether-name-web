    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="space-y-6 text-gray-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-black mb-3">Accounts</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-black mb-3">Agent Credentials</h2>
            <ul className="list-disc ml-6 space-y-1">
          ...
          <section>
            <h2 className="text-xl font-semibold text-black mb-3">Verification</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-black mb-3">Acceptable Use</h2>
            <ul className="list-disc ml-6 space-y-1">
          ...
          <section>
            <h2 className="text-xl font-semibold text-black mb-3">Changes</h2>
            <p>
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:hello@tether.name" className="text-black underline hover:no-underline">hello@tether.name</a>.
            </p>
          </section>
        </div>
      </div>
