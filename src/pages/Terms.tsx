    ...
    <div className="min-h-screen bg-[#1f1f1f] relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="space-y-6 text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mb-3">Agent identity</h2>
            <ul className="list-disc ml-6 space-y-1">
              <li>Private keys are generated by your agent during registration. You are solely responsible for storing them securely.</li>
              <li>Lost private keys cannot be recovered. You will need to register a new agent.</li>
          ...
          <section>
            ...
            <p>
              tether.name verifies that an agent holds a private key associated with a registered agent identity. Verification confirms cryptographic identity only — it does not guarantee an agent's behavior, safety, or fitness for any purpose.
            </p>
          </section>
